...
(function($) {
  ...
  $(function() {
    ...
    if ($("#doughnut").length) {
      ...
      var doughnut = new Chart(ctx).Doughnut($("#doughnut").data("data"), {})
...
function updateFieldsFieldHelpBlock(help_block, visualization_type, avlb_fields) {
  if (visualization_type == "table") {
    help_block.html("<pre>Syntax allowed  : {new_field} is sum|concat|id of {field}[, field]<br>"+$.trim(avlb_fields)+"</pre>")
